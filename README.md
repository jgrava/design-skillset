...
Clear design frameworks, decision criteria, and knowledge.
...
- **Commands** are triggered using slash notation (e.g., `/design-screen`)
- **Skills** are invoked automatically based on context or can be called explicitly
- Each plug-in can be used independently or in combination with others
